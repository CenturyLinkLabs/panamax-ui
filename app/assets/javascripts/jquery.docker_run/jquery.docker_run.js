(function($){
  ...
  $.PMX.DockerRun = function(el, options){
    ...
    base.defaultOptions = {
      ...
      portBindingsSelector: 'table.port-bindings tr td',
      hostPortSelector: '.host-port',
      containerPortSelector: '.container-port',
      protoSelector: '.proto',
      exposedPortsSelector: '.exposed-ports span.exposed-port',
      environmentVarsSelector: '.environment-variables .entries',
      envVarNameSelector: '.variable-name',
      envVarValueSelector: '.variable-value input',
      volumesSelector: '.volumes .data-containers ul.entries > li',
      volumeHostPathSelector: '.host-path',
      volumeContainerPathSelector: 'input.container-path',
      volumesFromSelector: '.volumes .mounted-containers ul.entries > li',
